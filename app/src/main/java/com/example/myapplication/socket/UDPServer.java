...
//                if (message.equals("我想和你进行连接66666666666")){
//                    AlertDialog.Builder builder = new AlertDialog.Builder(main_interface.context);
//                    builder.setTitle("系统提示").setMessage("是否接受请求").setPositiveButton("确定", new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialogInterface, int i) {
//                            UDPClient udpClient=new UDPClient("我确定和你进行连接66666666", receivePacket.getAddress().getHostAddress());
//                            new Thread(udpClient).start();
//                            Intent intent=new Intent(main_interface.context, MainActivity.class);
//                            Bundle bundle=new Bundle();
//                            try {
//                                bundle.putString("ip",InetAddress.getLocalHost().toString());
//                            } catch (UnknownHostException e) {
//                                throw new RuntimeException(e);
//                            }
//                            intent.putExtras(bundle);
//                            main_interface.context.startActivity(intent);
//                        }
//                    }).setNegativeButton("拒绝", new DialogInterface.OnClickListener() {
//                        @Override
//                        public void onClick(DialogInterface dialogInterface, int i) {
//                            UDPClient udpClient=new UDPClient("我拒绝和你进行连接66666666", receivePacket.getAddress().getHostAddress());
//                            new Thread(udpClient).start();
//                        }
//                    }).show();
//                }
//                else if (message.equals("我确定和你进行连接66666666")){
//                    Intent intent=new Intent(main_interface.context, MainActivity.class);
//                    Bundle bundle=new Bundle();
//                    bundle.putString("ip",receivePacket.getAddress().getHostAddress());
//                    intent.putExtras(bundle);
//                    main_interface.context.startActivity(intent);
//                } else if (message.equals("我拒绝和你进行连接66666666")) {
//                    Toast.makeText(main_interface.context, "对方拒绝了你的连接", Toast.LENGTH_SHORT).show();
//                }
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
        ...
        private void showDialog(udp user) {
            new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton("确定", (dialogInterface, i) -> {
                        udp message =new udp("oabwfobfoawbf","foibauowbfoubfwa","我想和你进行连接66666666666");//要获取自己的name和id，用数据库
                    ...
                    .setNegativeButton("拒绝", (dialogInterface, i) -> {
                        udp message =new udp("user.getUsername()","user.getUserid()","我想和你进行连接66666666666");//要获取自己的name和id,用数据库
                        UDPClient udpClient = new UDPClient(message, receivePacket.getAddress().getHostAddress());
                        new Thread(udpClient).start();
                    })
                    .show();
